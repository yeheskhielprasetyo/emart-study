...
@section('content')
@section('text', 'Brand')
<h5 class="float-right mt-2"><strong>Total Brand : {{$totalbrand}} </strong></h5>
<div class="col-lg-12">
    ...
    <tbody>
        @foreach ($brands as $item)
            <tr>
                ...
                <td>
                    <a href="{{route('brand.edit', $item->id)}}" data-toggle="tooltip" title="edit" class="float-left ml-2 btn btn-sm btn-outline-warning" data-placement="bottom"><i class="fas fa-edit"></i></a>
