...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link rel="shortcut icon" href="{{asset('demo13/src/media/logos/favicon.ico')}}" />
		<!--begin::Fonts-->
	...
	<body id="kt_body" class="bg-body">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/dozzy-1/14.png">
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" method="POST" action="{{ route('login') }}">
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" type="email" name="email" autocomplete="off" value="{{ old('email') }}" autofocus/>
				...
				<div class="d-flex flex-center flex-column-auto p-10">
					...
					<div class="d-flex align-items-center fw-bold fs-6">
						<a href="#" class="text-muted text-hover-primary px-2">Copyright by YPR</a>
					</div>
					<!--end::Links-->
				</div>
				<!--end::Footer-->
		...
		<script src="{{asset('demo13/dist/assets/js/custom/authentication/sign-in/general.js')}}"></script>
